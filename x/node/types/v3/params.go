...
func NewParams(
	deposit sdk.Coin, activeDuration time.Duration, minGigabytePrices, minHourlyPrices sdk.Coins, maxLeaseHours,
	minLeaseHours, maxSessionGigabytes, minSessionGigabytes, maxSessionHours, minSessionHours int64,
