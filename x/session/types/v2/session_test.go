	...
	tests := []struct {
		...
		},
		{
			...
			fields{
				...
				NodeAddress:    base.TestBech32NodeAddr20Bytes,
				Address:        base.TestBech32AccAddr20Bytes,
				Bandwidth:      v1base.Bandwidth{Upload: sdkmath.Int{}, Download: sdkmath.Int{}},
			},
			true,
		},
		{
			...
			fields{
				...
				NodeAddress:    base.TestBech32NodeAddr20Bytes,
				Address:        base.TestBech32AccAddr20Bytes,
				Bandwidth:      v1base.Bandwidth{Upload: sdkmath.Int{}, Download: sdkmath.NewInt(1000)},
			},
			true,
		},
		{
			...
			fields{
				...
				NodeAddress:    base.TestBech32NodeAddr20Bytes,
				Address:        base.TestBech32AccAddr20Bytes,
				Bandwidth:      v1base.Bandwidth{Upload: sdkmath.NewInt(1000), Download: sdkmath.Int{}},
			},
			true,
		},
		{
